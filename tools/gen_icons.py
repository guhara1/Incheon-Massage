...
def icon(size, pad_ratio=.14, maskable=False):
    ...
    d.text((size/2, size/2 - inner*0.04), "7", font=f, fill=(26, 18, 8), anchor="mm")
    return base
...
d.text((80, 250), "인천 세븐 마사지", font=fb, fill=(243, 243, 245))
d.text((82, 350), "인천 전지역 출장마사지·홈타이 방문 예약 안내 · 연중무휴 24시간", font=fs, fill=(154, 154, 163))
mark = rounded(grad(120), 26)
ov.alpha_composite(mark, (80, 110))
md = ImageDraw.Draw(ov)
md.text((140, 158), "7", font=font(70), fill=(26, 18, 8), anchor="mm")
